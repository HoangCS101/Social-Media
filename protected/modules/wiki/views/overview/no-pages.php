    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="text-center wiki-welcome">
                <h1><?= Yii::t('WikiModule.base', 'There are no topics yet!') ?></h1>
                <?php if ($canCreatePage): ?>
                    <h2><?= Yii::t('WikiModule.base', 'Let is start creating a topic, facilitate knowledge transfer and make it available to your users in the easiest way possible.') ?>
                    </h2>
                    <br>
                    <p>
