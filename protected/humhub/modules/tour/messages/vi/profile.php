...
return array (
  ...
  'Just like in the space, the user profile can be personalized with various modules.<br><br>You can see which modules are available for your profile by looking them in “Modules” in the account settings menu.' => 'Giống như trong các diễn đàn, trang cá nhân của người sử dụng cũng có thể được cá nhân hóa với nhiều modules chức năng. <br /><br /> Bạn có thể nhìn thấy module nào đang có sẵn để cài trên trang profile của mình bằng cách tìm chúng trong mục "Modules" trên thực đơn thiết lập tài khoản.',
