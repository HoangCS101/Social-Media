 ...
 * @since 0.5
 */
class SpaceRightNavigation extends ProfileHeaderNavigation
{
    /** @var Space */
    public $space;
    ...
    public function init()
    {
        ...
        $this->panelTitle = Yii::t('SpaceModule.base', '');
        ...
        $this->addEntry(new MenuLink([
            'label' => Yii::t('SpaceModule.base', 'Photos'),
            'url' => $this->space->createUrl('/space/space/home'),
            // 'icon' => 'stream',
            'sortOrder' => 100,
            'isActive' => MenuLink::isActiveState('space', 'space', 'photos'),
        ]));
